...
token = '6246314158:AAFQdLYgedQjAU1f140RYZP-FEt_Dz4KKBM'
bot = telebot.TeleBot(token)

@bot.message_handler(commands=['start'])
def start_message(message):
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1)
    button1 = types.KeyboardButton(text="ССК Легион")
    button2 = types.KeyboardButton(text="Тк Эдельвейс")
    button3 = types.KeyboardButton(text="ВПК")
    button4 = types.KeyboardButton(text="Движение первых")
    button5 = types.KeyboardButton(text="Профессионалитет")
    button6 = types.KeyboardButton(text="Волонтёрский корпус")
...
def function(message):
    if message.text == "ССК Легион":
        markup1 = types.ReplyKeyboardMarkup(row_width=1)
        button60 = types.KeyboardButton(text="Команды ССК „Легион“")
        button70 = types.KeyboardButton(text="Приказы ССК „Легион“")
    ...
    if message.text == "Команды ССК „Легион“":
        ...
        button0_1 = types.InlineKeyboardButton(text="Волейбол 🏐", callback_data='commands_volleyball')
        button0_2 = types.InlineKeyboardButton(text="Баскетбол 🏀", callback_data='commands_basketball')
        button0_3 = types.InlineKeyboardButton(text="Теннис 🏓", callback_data='commands_tennis')
    ...
    if message.text == "Тк Эдельвейс":
        ...
        button12 = types.KeyboardButton(text="Команды ССК „Легион“")
        button13 = types.KeyboardButton(text="Приказы ССК „Легион“")
    ...
    if message.text == "Движение первых":
        ...
        button42 = types.KeyboardButton(text="Команды ССК „Легион“")
        button43 = types.KeyboardButton(text="Приказы ССК „Легион“")
